        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 lg:gap-16 mb-10">
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a href="https://www.instagram.com/cyxorlearning" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-lg bg-white/5 flex items-center justify-center text-white/70 hover:text-cyan hover:bg-cyan/10 transition-colors border border-white/10">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
